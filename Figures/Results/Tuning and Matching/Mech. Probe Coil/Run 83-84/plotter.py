...
files = ['83.csv', '83,1.csv', '83,2.csv', '83,3.csv', '83,4.csv', '83,5.csv', '83,6.csv', '83,7.csv', '83,8.csv', '83,9.csv', '84.csv']
S11_data = {}
for file in files:
    frequencies = []
    S11_dB = []
...
plt.ylabel('S11(dB)')
plt.xlabel('Frequency (MHz)')
plt.title('S11 of the mechanically tuned probe coil at the desired frequencies')
plt.grid(True)
